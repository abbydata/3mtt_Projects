...
## Business Problem / Objectives / Questions
...
- Removed irrelevant columns and standardized inconsistent job role categories.
- Converted open-text responses into consistent categories using text matching and labeling.
- Grouped age into bands and defined salary categories for structured analysis.
- Extracted weekday names and sort-order values to ensure chronological slicer behavior.
- Preserved data integrity by handling null and blank values carefully, labeling unknown entries rather than discarding records.
...
- DAX measure creation and calculated column modeling
- Dashboard design for strategic storytelling
- Data categorization and text standardization
...
- Prioritize competitive compensation packages and transparent career paths to reduce turnover.
...
- Report design and data visualization best practices
...
Report by Aishat Omolabake Ajibola
